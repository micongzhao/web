package com.ittx.studentmanager.db;
...
public class StudentDB extends ConnectDB {
	...
	public void addStudent(Student student) {
		...
		try {
			...
			ps.setString(5, student.getFileUrl());
	...
	public void updateStudent(Student student){
		...
		try {
			...
			ps.setString(4, student.getFileUrl());
	...
	public ArrayList<Student> getAllStudent() {
		...
		try {
			...
			while (rs.next()) {
				...
				Student student = new Student(name, number, age, sex,url);
